...
import { PrivyUser, PrivySuccessObject, PrivyEthereumEmbeddedWalletAccount, PrivySolanaEmbeddedWalletAccount, PrivyBitcoinSegwitEmbeddedWalletAccount, PrivyBitcoinTaprootEmbeddedWalletAccount, PrivyLinkedAccount } from '@privy-io/public-api';
...
/** @deprecated use the PrivyEmbeddedWalletAccount type instead */
type EmbeddedWallet = PrivyEmbeddedWalletAccount;
/** @deprecated use the PrivyUser type instead */
type User = PrivyUser;
/** @deprecated use the PrivyLinkedAccount type instead */
type LinkedAccountWithMetadata = PrivyLinkedAccount;
type OAuthFlowState = {
    status: 'initial';
} | {
    status: 'loading';
...
export { AuthLinkSuccessCallback as A, isReconnecting as B, CreateOrRecoverEmbeddedWalletProps as C, isConnecting as D, ErrorCallback as E, FarcasterFlowState as F, GenerateSiweMessage as G, isDisconnected as H, isNotCreated as I, isCreating as J, hasError as K, LinkFarcasterInput as L, MfaConfig as M, needsRecovery as N, OtpLinkHookOptions as O, PasskeyFlowState as P, PasskeyLinkHookOptions as Q, RecoveryFlowState as R, SiweFlowState as S, PasskeyHookResult as T, User as U, PasskeyLoginHookOptions as V, WalletRecoveryCallbacks as W, SubmitPasskeyInput as X, AuthSuccessCallback as a, OtpLinkHookResult as b, OtpLoginHookOptions as c, OtpLoginHookResult as d, SubmitFarcasterOptions as e, LoginWithFarcasterInput as f, OAuthHookOptions as g, EmbeddedWalletState as h, EmbeddedSolanaWalletState as i, OtpFlowState as j, OAuthFlowState as k, SolanaWalletRecoveryCallbacks as l, PrivyEmbeddedWalletAccount as m, EmbeddedWallet as n, LinkedAccountWithMetadata as o, CreateEthereumEmbeddedWalletOpts as p, RecoverEthereumEmbeddedWalletOpts as q, CreateSolanaEmbeddedWalletOpts as r, RecoverSolanaEmbeddedWalletOpts as s, SetRecoveryProps as t, CustomAuthFlowState as u, EmbeddedWalletActions as v, EmbeddedWalletStatus as w, EmbeddedSolanaWalletActions as x, EmbeddedSolanaWalletStatus as y, isConnected as z };
