...
with_node \
  ...
  --target "/Users/luguoliang/expoPrivy/ios/Pods/Target Support Files/Pods-expoPrivy/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "@privy-io/expo-native-extensions" "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-linking" "expo-secure-store" "expo-web-browser" "react-native-passkeys"
